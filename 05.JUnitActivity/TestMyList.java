...
public class TestMyList {
    ...
    public void testInsertSize() {
        // TODO: Complete this test. The test should insert 10 integers, and check if
        // the .size()
        // method of ListADT returns the correct result after inserting each one of them
        // into the list.
    ...
    // and checks after each remove if the .size() method of ListADT returns the
    // correct result.
    ...
    public void testRemoveSize() {
        ...
        for (int i = 0; i < 10; i++) {
            _instance.remove(0);
            assertEquals(9 - i, _instance.size());
        }
    }
