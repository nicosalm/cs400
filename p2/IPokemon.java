 ...
 * {@code PokemonDW}) during role code.
 */
public interface IPokemon extends Comparable<IPokemon> {
    ...
    /**
     * Gets the first type of the Pokemon (e.g. <i>Water</i>). Depending on the
     * Pokemon, this may be their only type.
     *
    ...
    /**
     * <p>
     * Pokemon may or may not have two types (e.g. Water and Flying). Since not all
     * Pokemon have a second type,
     * we use an {@link Optional} to represent the possibility of absence—which
     * generally is better practice than using {@code null}.
     * </p>
     *
     * <br>
     *
     ...
     * <p>
     * Check that the {@code Optional} holds a value with
     * {@link Optional#isPresent()}.
     * <ul>
     * <li>If it <b>does</b> contain a value, you can retrieve it with
     * {@link Optional#get()}.</li>
     * <li>If it doesn't contain a value, <b>do not</b> call {@code get()}—it will
     * throw a {@link java.util.NoSuchElementException} if you do.</li>
     * </ul>
     * Account for both cases: (1) when a value is present, and (2) when a value is
     * absent.
     * </p>
     *
     * <br>
     ...
     * </pre>
     *
     * @return an {@link Optional} of the Pokemon's second type, which may or may
     *         not contain a type.
     * @see Optional
     */
    Optional<PokemonType> getSecondaryType();

    // NOTE: This method will only be used if we decide to scope up the project.
    // Feel free to use a stub implementation for this
    // method (e.g. by returning a dummy value) and ignore it unless we're told we
    // need to scope up.
    /**
     * <p>
     * Gets the damage multiplier that would be applied to an attack against this
     * Pokemon.
     * The higher the damage multiplier, the weaker this Pokemon is to the type
     * {@code attackerType}.
     * </p>
     * <br>
     *
     ...
     * <ul>
     * <li>if {@code m >= 2}, the attacker's type is <b>super effective</b> against
     * this Pokemon.</li>
     * <li>if {@code m >= 1}, the attacker's type is <b>effective</b> against this
     * Pokemon.</li>
     * <li>if {@code m > 0}, the attacker's type is <b>weak</b> against this
     * Pokemon.</li>
     * <li>if {@code m = 0}, the attacker's type has <b>no effect</b> against this
     * Pokemon.</li>
     * </ul>
     *
     * @param attackerType the type this Pokemon is attacked by
     * @return the damage multiplier that would be applied to an attack against this
     *         Pokemon
     */
    ...
    /**
     * The base stat total can also be seen as an overall "combat power" rating.
     * Pokemon with better base stat totals
    ...
    /**
     * Also known as health. In an actual Pokemon battle, when this reaches zero,
     * the Pokemon faints.
     *
    ...
    /**
     * Gets the experience growth factor; this represents how quickly the Pokemon
     * levels
     ...
     *
     * <p>
     * This method returns the number of steps needed to hatch an egg for a specific
     * Pokemon.
     * </p>
     *
     ...
     * This method returns the base happiness; i.e. the default happiness they start
     * with the moment they meet a trainer.
     *
    ...
    /**
     * @return a ratio from [0, 1] representing how often this Pokemon, when hatched
     *         or encountered in the wild, is male.
     */
