 ...
 */
public class PokemonFD implements IPokemon {
     ...
     */
    public int getPokedexNumber() { return 0; }
     ...
     */
    public PokemonType getPrimaryType() { return PokemonType.NORMAL; }
     ...
     * @see Optional
     */
    public Optional<PokemonType> getSecondaryType() { Optional<PokemonType> opt = Optional.of(PokemonType.NORMAL); return opt; }
     ...
     */
    public double getDamageMultiplierFor(PokemonType attackerType) { return 0.0; }

    /**
     * @return true if the Pokemon is legendary, false otherwise
     */
    public boolean isLegendary() { return false; }
     ...
     */
    public int getBaseStatTotal() { return 0; }
     ...
     */
    public int getAttackStat() { return 0; }

    /**
     * @return the Pokemon's defense stat.
     */
    public int getDefenseStat() { return 0; }

    /**
     * @return the Pokemon's special attack stat.
     */
    public int getSpecialAttackStat() { return 0; }

    /**
     * @return the Pokemon's special defense stat.
     */
    public int getSpecialDefenseStat() { return 0; }

    /**
     * @return the Pokemon's speed stat.
     */
    public int getSpeedStat() { return 0; }
     ...
     */
    public String[] getAbilityNames() { return new String[] {"NAME", "NAME", "NAME"}; }
     ...
     */
    public long getExperienceGrowthFactor() { return 0000; }
     ...
     */
    public int getBaseStepsNeededToHatchEgg() { return 0; }
     ...
     */
    public int getBaseHappiness() { return 0; }

    /**
     * @return the height of the Pokemon, in meters
     */
    public Optional<Float> getHeightInMeters() { return null; }

    /**
     * @return a ratio from [0, 1] representing how often this Pokemon, when hatched or encountered in the wild, is male.
     */
    public Optional<Float> getPercentageMale() { return null; }

    // unimplmented method to prevent error, not used in FrontendFD
    @Override
    public int compareTo(IPokemon o) { return 0; }
}